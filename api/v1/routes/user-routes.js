...
import { addFeedback, getCertificates, getUserEvents, getUsers, login, loginWithGoogle, register, signup } from '../../../controllers/user-controller.js';
...
router.post('/feedback', checkToken, addFeedback);
